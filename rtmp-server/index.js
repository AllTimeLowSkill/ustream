...
nms.on('postPublish', async (id, streamPath, args) => {
  ...
  const { data } = await axios.get(`http://localhost:3000/api/user/${streamKey}`)
  const stream = await axios.post('http://localhost:3000/api/stream/create', { streamId: id, streamKey, username: data.username })
