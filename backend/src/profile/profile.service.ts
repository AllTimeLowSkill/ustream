...
export class ProfileService {
    ...
    createProfile = async (id: string, avatar: any) => {
        if(avatar) {
            ...
            return await this.profileRepository.save({ firstname: '', lastname: '', aboutMe: '', userId: id, avatar: fileName })
                
        }
        
        return await this.profileRepository.save({ firstname: '', lastname: '', aboutMe: '', userId: id, avatar: '' })
    }
