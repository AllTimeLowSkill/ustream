...
const StreamChat = ({ id }) => {
    ...
    return (
        <section className="flex flex-col justify-between px-[18px] rounded-[10px] bg-[#240046]">
            <span className="text-base text-white font-semibold inline-block w-full text-center py-[18px] border-b-2 border-solid border-[#E0AAFFB2]">STREAM CHAT</span>
            ...
            <footer>
                ...
                <Button accent={true} title='Send message' sx={{ margin: 'my-[12px]' }} onClick={() => handleSendMessage()} />
            </footer>
        </section>
    )
}
