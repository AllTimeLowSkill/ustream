...
const Category = () => {
    ...
    const categoeyStreams = useMemo(() => streams.filter(stream => stream.category === id), [id, streams])
        ...
        <div className="px-[28px] py-[48px]">
            <header className="flex">
                ...
                <section className="px-[28px] flex flex-col justify-between h-[240px]">
                    <span className="text-[40px] text-white font-semibold">{ category.title }</span>
